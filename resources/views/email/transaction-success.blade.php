                          ...
                          <tbody>
                            <tr>
                              <td style="width:180px;">
                                <img alt="" height="auto" src="images/logo@2x.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="180" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;text-align:left;color:#071c4d;">Hi, Bambang Satrio Gandhi <br> <br> Tiket digital kamu sudah berhasil dicetak. <br> Booking ID <strong>#22081996</strong></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071c4d;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:16px;line-height:25px;table-layout:auto;width:100%;border:none;">
                                  <tr>
                                    <td colspan="3">Members</td>
                                  </tr>
                                  <tr>
                                    <td><strong>Bambang Satrio Gandhi</strong></td>
                                    <td style="text-align: right">Singapore, SG</td>
                                  </tr>
                                  <tr>
                                    <td><strong>Bagas Satrio</strong></td>
                                    <td style="text-align: right">Singapore, SG</td>
                                  </tr>
                                </table>
                              </td>
                              ...
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071c4d;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:25px;table-layout:auto;width:100%;border:none;">
                                  ...
                                  <tr>
                                    ...
                                    <td style="text-align: right">20 Jan, 2022</td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="center" bgcolor="#ff9e53" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#ff9e53;" valign="middle">
                                        <p style="display:inline-block;background:#ff9e53;color:#ffffff;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;"> Check Detail </p>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:16px;line-height:28px;text-align:left;color:#071c4d;">Butuh Bantuan ?</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                      ...
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                          <tr>
                            ...
                            font-family: Assistant, Helvetica, Arial, sans-serif;"> support@nomads.id <br> 021-2022-2024 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888b93;">2022 Nomads Copyright All Rights Reserved</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
